...
# ++++++++++++++++++++IMAGES++++++++++++++++++++++++++
blank_image = PhotoImage(file="RPS/blank.png")
rock_player = PhotoImage(file="RPS/rock_player.png")
rock_player_ado = rock_player.subsample(3, 3)
paper_player = PhotoImage(file="RPS/paper_player.png")
paper_player_ado = paper_player.subsample(3, 3)
scissor_player = PhotoImage(file="RPS/scissor_player.png")
scissor_player_ado = scissor_player.subsample(3, 3)
rock_computer = PhotoImage(file="RPS/rock_computer.png")
paper_computer = PhotoImage(file="RPS/paper_computer.png")
scissor_computer = PhotoImage(file="RPS/scissor_computer.png")
